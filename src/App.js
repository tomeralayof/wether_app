...
async function success(pos) {
  ...
  let longitude = crd.longitude;
   let {data} = await axios.get(`https://dataservice.accuweather.com/locations/v1/cities/geoposition/search?apikey=k9PC7qvAJjvsXFtNNpR5dG9kUSQ2kJix&q=${latitude}%2C${longitude}`);
